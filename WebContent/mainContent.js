      				...
      				for (var i = 0; i < json.length; i++) 
        				{
  							text += "<div class=\"candidate-info-holder\">"	 
  								text += "<div class=\"image-holder position-img\">"	 				 
  									text +=	"<a href=\"#\" onClick=\"changePerson("+json[i].id+")\">"
...
/*		function changePerson(id) {
  			...
  			xhttp.onreadystatechange = function() 
  			{
    			...
    			{   
					var json = JSON.parse(this.responseText)
      				var text = ""
      					text += "<table id=\"table-example-2\"  style=\"width:75%\">"
      		  			text += "<tr>"	
      		  			text += "<td>" + "Voornaam" + "</td>"	
          		  		text += "<td>" + json.firstName + "</td>"	
              		  	text += "</tr>"	 	
          		  		text += "<tr>"	
              		  	text += "<td>" + "Achternaam" + "</td>"	
                  		text += "<td>" + json.lastName + "</td>"	
                      	text += "</tr>"	 
              		  	text += "<tr>"	
                      	text += "<td>" + "Vaardigheden" + "</td>"	
                        text += "<td>" + json.skills + "</td>"	
                        text += "</tr>"	      		  	    
                  		text += "<tr>"	
                        text += "<td>" + "Opleiding" + "</td>"	
                        text += "<td>" + json.opleiding + "</td>"	
                        text += "</tr>"	  
                        text += "<td>" + "Ervaring" + "</td>"	
                        text += "<td>" + json.ervaring + "</td>"	
                        text += "</tr>"	 
                        text += "<td>" + "Werkervaring" + "</td>"	
                        text += "<td>" + json.werkervaring + "</td>"	
                        text += "</tr>"	   
                        text += "<td>" + "Profiel" + "</td>"	
                        text += "<td>" + json.profiel + "</td>"	
                        text += "</tr>"	 
                        text += "<td>" + "Plaatje" + "</td>"	
                        text += "<td>" + json.plaatje + "</td>"	
                        text += "</tr>"	     
                        text += "<td>" + "CV" + "</td>"	
                        text += "<td>" + json.cv + "</td>"	
                        text += "</tr>"	 
